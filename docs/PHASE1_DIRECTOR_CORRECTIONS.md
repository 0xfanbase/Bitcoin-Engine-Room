...
4. **Repo naming is already resolved.** GitHub slug is `0xfanbase/Bitcoin-Engine-Room` (Pages URL `https://0xfanbase.github.io/Bitcoin-Engine-Room/`). No rename; use this slug consistently wherever the spec says `btc-engine-room`.
